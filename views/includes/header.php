        ...
        <div class="container">
            <div class="header-middle-left">
                <div class="header-logo">
                    <a href="index.php">
                        <img src="/Webbandoan2/public/assets/img/logo.png" alt="" class="header-logo-img" />
                    </a>
                </div>
            </div>
                ...
                <ul class="header-middle-right-list">
                    <li class="header-middle-right-item dropdown open">
                        ...
                        <ul class="header-middle-right-menu">
                            <li>
                                <a class="dropdown-item" href="dangnhap.php"><i
                                        class="fa-solid fa-right-to-bracket"></i>Đăng nhập</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="dangky.php"><i class="fa-solid fa-user-plus"></i>Đăng
                                    kí</a>
                            </li>
                        </ul>
                    </li>
...
<div class="advanced-search" id="advanced-search">
    <form id="advanced-search-form" method="GET" action="index.php" class="container">
        ...
        <input type="hidden" id="advanced-keyword" name="keyword" value="<?php echo htmlspecialchars($keyword); ?>">
