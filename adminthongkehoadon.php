...
// Kết nối CSDL
try {
  $pdo = new PDO("mysql:host=127.0.0.1;dbname=webbandoann;charset=utf8", "root", "");
...
// Lấy sản phẩm trong đơn hàng từ chitietdonhang
$sql_items = "
    SELECT 
        s.TEN_SP AS product,
        s.HINH_ANH AS image,
        ...
        <div class="container" id="order-content">
          <?php if ($order): ?>
            ...
            <div class="inner-trangthai">
              ...
              <div class="inner-ngay">Trạng thái vận chuyển:
                <i><?php echo htmlspecialchars($order['shippingStatus']); ?></i>
              </div>
            </div>
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="inner-diachi">
                  ...
                  <div class="inner-gth">
                    ...
                    <div class="inner-dc">Địa chỉ:
                      <?php echo htmlspecialchars($order['address'] ?: 'Không có địa chỉ'); ?>
                    </div>
            ...
            <div class="inner-menu">
              <?php foreach ($items as $item): ?>
                <div class="inner-item">
                  ...
                  <div class="inner-gia"><?php echo number_format($item['quantity'] * $item['price'], 0, ',', '.'); ?> ₫
                  </div>
                </div>
              <?php endforeach; ?>
